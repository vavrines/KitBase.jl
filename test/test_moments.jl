...
KitBase.pressure(f2, f2, rand(4), u2, u2, w2, 1, VDF{2,2})
KitBase.pressure(f3, rand(5), u3, u3, u3, w3, 1, VDF{1,3})
KitBase.stress(f1, rand(3), u1, w1)
KitBase.stress(f2, rand(4), u2, u2, w2)
KitBase.stress(f3, rand(5), u3, u3, u3, w3)
