...
KitBase.flux_gks!(zeros(3), [1.0, 0.0, 2.0], γ, inK, 1e-3, 0.72)
KitBase.flux_gks!(zeros(4), [1.0, 0.0, 0.0, 2.0], γ, inK, 1e-3, 0.72)
KitBase.flux_gks!(zeros(5), [1.0, 0.0, 0.0, 0.0, 2.0], γ, inK, 1e-3, 0.72)
