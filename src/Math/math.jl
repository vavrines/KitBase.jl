...
export central_diff, central_diff!, central_diff2, central_diff2!, upwind_diff, upwind_diff!, unstruct_diff
export maxwell_boltzmann, maxwell_boltzmann_prime, maxwell_boltzmann_dual, maxwell_boltzmann_dual_prime, kinetic_entropy
